...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/modulegraph-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8324&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/modulegraph-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `modulegraph` can be installed with:

```
conda install modulegraph
```

It is possible to list all of the versions of `modulegraph` available on your platform with:
